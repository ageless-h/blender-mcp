...
BLENDER_PROMPTS: dict[str, dict[str, Any]] = {
    "blender-scene-setup": {
        ...
        "arguments": [
            {
                "name": "style",
                "description": "Rendering style: realistic, stylized, or architectural",
                "required": True,
            },
    ...
    "blender-material-create": {
        ...
        "arguments": [
            {
                "name": "material_type",
                "description": "Material type: metal, glass, wood, fabric, emissive, custom",
                "required": True,
            },
    ...
    "blender-animate": {
        ...
        "arguments": [
            {
                "name": "animation_type",
                "description": "Animation type: transform, camera, character, or physics",
                "required": True,
            },
    ...
    "blender-composite": {
        ...
        "arguments": [
            {
                "name": "effects",
                "description": "Effect type: glow, color-grade, vignette, depth-of-field, or custom",
                "required": True,
            },
        ],
    },
    ...
    "blender-usage-strategy": {
        ...
        "description": (
            "Overall strategy for using Blender MCP tools effectively: "
            "read before write, layer selection priority, and best practices."
        ),
        "arguments": [],
    },
    "blender-resource-strategy": {
        ...
        "description": (
            "Strategy for reading Blender data efficiently: "
            "controllable granularity, avoiding excessive data retrieval."
        ),
        "arguments": [],
    },
    ...
    return [
        {
            ...
            "content": {
                ...
                "text": (
                    ...
                    "Diagnostic workflow:\n"
                    "1. **Scene overview** — "
                    "Call `blender_get_scene` with "
                    "include=['stats','render','world','version'].\n"
    ...
    return [
        {
            ...
            "content": {
                ...
                "text": (
                    ...
                    "- **Prefer specialized tools**: `blender_manage_material` over "
                    "`blender_execute_script` for material work."
                ),
            },
        }
    ]
    ...
    return [
        {
            ...
            "content": {
                ...
                "text": (
                    ...
                    "- **`blender_get_node_tree`**: Use `depth='summary'` for overview, "
                    "`depth='full'` only when editing.\n"
    ...
    return [
        {
            ...
            "content": {
                ...
                "text": (
                    ...
                    '- **"Node not found"**: Call `blender_get_node_tree` with '
                    "`depth='full'` to see actual node names.\n"
                    ...
                    "4. **Fallback**: If a specialized tool fails, "
                    "try `blender_execute_operator` or `blender_execute_script`.\n"
